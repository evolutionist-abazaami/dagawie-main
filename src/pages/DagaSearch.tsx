...
interface SearchResult {
  ...
  findings?: Array<string | { detail?: string; description?: string }>;
  recommendations?: Array<string | { detail?: string }>;
}
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (data.locations && data.locations.length > 0) {
        ...
        const markers = data.locations.map((loc: { lat?: number; lng?: number; name?: string }, idx: number) => ({
          lat: loc.lat || 6.5,
          lng: loc.lng || -1.5,
