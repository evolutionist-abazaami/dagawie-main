...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are Dagawie Intelligence AI Assistant, an expert in geospatial analysis, environmental monitoring, and satellite imagery interpretation for Africa.
...
You help users:
1. Understand how to use Dagawie Intelligence features (DagaWitness, DagaSearch, Analytics, Dashboard)
...
Current Dagawie Intelligence features:
- DagaWitness: Select locations and run AI-powered environmental change analysis
- DagaSearch: Natural language queries for environmental data
