...
const MapLibreMap = ({
      ...
      terrain: {
        ...
        sources: {
          terrain: {
            ...
            tileSize: 256,
            attribution:
              'Map tiles by <a href="https://opentopomap.org">OpenTopoMap</a>, under <a href="https://creativecommons.org/licenses/by-sa/3.0/">CC BY-SA</a>. Data by <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors.',
          },
          "osm-labels": {
            type: "raster",
            tiles: ["https://a.tile.openstreetmap.org/{z}/{x}/{y}.png"],
    ...
    try {
      const response = await fetch(
        `https://nominatim.openstreetmap.org/reverse?format=json&lat=${lat}&lon=${lng}&zoom=10`,
        {
          headers: {
            "Accept-Language": "en",
            "User-Agent": "Dagawie Intelligence Environmental Analysis App",
          },
        }
      );
      if (response.ok) {
  ...
  useEffect(() => {
    ...
    // Control visibility of text layers and our overlay labels
    const labelLayers = ["place-labels", "poi-labels", "road-labels", "osm-labels"];
