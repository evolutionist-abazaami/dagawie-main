...
const AIAssistant = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Hello! I'm your Dagawie AI Assistant. I can help you with environmental analysis, satellite imagery interpretation, and navigating the platform. How can I assist you today?",
    },
  ]);
    ...
    >
      ...
      <div className="flex items-center justify-between p-3 border-b border-border bg-gradient-ocean rounded-t-lg">
        <div className="flex items-center gap-2 text-primary-foreground">
          ...
          <span className="font-semibold">Dagawie Intelligence Assistant</span>
        </div>
