...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-hero/70 backdrop-blur-xl border-b border-border shadow-glow">
      <div className="container mx-auto px-4 lg:px-6 py-4">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 lg:gap-3 group">
            <img 
              src={dagawieLogo} 
              alt="Dagawie Intelligence Logo" 
              className="h-10 w-10 lg:h-12 lg:w-12 rounded-full shadow-elevated transition-transform group-hover:scale-105"
            />
            <span className="text-xl lg:text-2xl font-bold bg-gradient-hero bg-clip-text text-transparent">
