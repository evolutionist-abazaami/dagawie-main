...
export function toGeoJSON(
  ...
  collectionName: string = "Dagawie Intelligence Analysis Export",
...
export function toKML(
  features: AnalysisFeature[],
  documentName: string = "Dagawie Intelligence Analysis Export"
): string {
...
<kml xmlns="http://www.opengis.net/kml/2.2">
  <Document>
    ...
    <description>Exported from Dagawie Intelligence - Environmental Monitoring Platform</description>
 ...
 */
export function dbResultToFeature(result: {
  id: string;
  coordinates: string | { lat?: number; latitude?: number; lng?: number; longitude?: number; lon?: number };
  region?: string;
