...
const SharedReport = () => {
  ...
  const downloadPDF = () => {
    ...
    pdf.save(`Dagawie_Shared_Report_${shareId}.pdf`);
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-primary text-primary-foreground py-6">
        <div className="container max-w-4xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-primary-foreground/80 text-sm mb-1">Dagawie Shared Report</p>
      ...
      <div className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="text-center text-sm text-muted-foreground pt-6 border-t">
          <p>
            Powered by <span className="font-semibold text-primary">Dagawie</span> Environmental Intelligence Platform
          </p>
          <Link to="/" className="text-primary hover:underline mt-2 inline-block">
            Learn more about Dagawie →
          </Link>
        </div>
      </div>
    </div>
